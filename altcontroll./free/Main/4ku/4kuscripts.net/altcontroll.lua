if game.PlaceId == 2788229376 then
    ...
    if game.Players.LocalPlayer.UserId == getgenv().controller then
        ...
        Rank_17.Text =
            "This script has been made by rodizzy#0001 / .gg/4ku AND script was mostly made by drestiny#0001"
    ...
    for i, v in pairs(getgenv().alts) do
        ...
        if v == game.Players.LocalPlayer.UserId then
            ...
            TextLabel.Text = "Synus Alt controller"
            ...
            local function PPEQE_fake_script() -- TextButton.LocalScript 
                ...
                function leftClick()
                    setclipboard("https://discord.gg/4ku")
                end
    ...
    game.Players.LocalPlayer:Kick(" error 4ku scripts : Script works Only da hood.")
end
